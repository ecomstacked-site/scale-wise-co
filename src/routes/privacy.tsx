...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy — EcomStack" },
      { name: "description", content: "EcomStack privacy policy — how we collect, use, and protect your data." },
    ],
  }),
    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 space-y-8">
          ...
          {[
            { title: "Introduction", content: "EcomStack (\"we,\" \"our,\" or \"us\") respects your privacy and is committed to protecting your personal data. This privacy policy explains how we collect, use, and safeguard information when you visit our website." },
            ...
            { title: "Your Rights", content: "You may request access to, correction of, or deletion of your personal data at any time by contacting us at hello@ecomstack.com." },
            ...
            { title: "Contact Us", content: "If you have questions about this privacy policy, please contact us at hello@ecomstack.com." },
          ].map((section) => (
